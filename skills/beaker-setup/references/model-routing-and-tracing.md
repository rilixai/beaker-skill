...
Use built-in framework integrations first, scoped only to the candidate-workflow invocation.
Frameworks supported under
...
For frameworks without built-in integration — including provider SDKs, LlamaIndex, and
